...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2022 a las 22:43:02
...
--
-- Base de datos: `sysasistencia_edy`
--
...
(1, 'Cwil', 'Jr. Lima 450', '-13.65055300087334', '            -73.42780364006432', 'cwil2.png', '8000', '06:00:00', '07:00:00', '12:00:00', 'LU_MA_MI_JU_VI_SÁ_DO', '10.00');
...
(2, 'WILFREDO VARGAS CARDENAS', '70378801', '$2y$10$y6FYe/t2glHaDK1wipMy5ePkXar5LnkFXFhLSXoURMoQ.vsaAvUi2', '1234', NULL, NULL, NULL, NULL, '2021-03-24 07:06:43', 'ACTIVO', 'ADMINISTRADOR', 'logo.jpg', 1),
(6, 'FRANCISCO ROJAS', '12345678', '$2y$10$QwR5ullYUQ5EwwhBvvIqw.VKs1WvRWaW7iRm7GuneeYcKGKUjkjC2', '423423423', 'Jr. Santa Fe calle 343', NULL, NULL, '10.00', '2022-03-09 07:50:33', 'ACTIVO', 'PERSONAL', NULL, 1);
...
--
-- Indices de la tabla `venta_salida`
--
ALTER TABLE `venta_salida`
  ADD PRIMARY KEY (`idVentaSalida`),
...
--
-- AUTO_INCREMENT de la tabla `venta_salida`
--
ALTER TABLE `venta_salida`
  MODIFY `idVentaSalida` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `venta_salida`
--
ALTER TABLE `venta_salida`
  ADD CONSTRAINT `venta_salida_ibfk_1` FOREIGN KEY (`IdRegistro`) REFERENCES `registro` (`IdRegistro`);
COMMIT;
