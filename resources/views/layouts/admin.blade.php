      ...
      <div class="input-group input-group-sm">
        ...
        <aside class="main-sidebar sidebar-dark-danger elevation-4">
            ...
            @if (auth()->user()->TipoUsuario == 'PERSONAL')
                <a href="{{ asset('asistencia/registro') }}" class="brand-link bg-danger">
                @else
                    <a href="{{ asset('dashboard-administrador') }}" class="brand-link bg-danger">
            @endif
          ...
          <div class="input-group-append">
            ...
            {{ 'dashboard-administrador' == request()->segment(1) ? 'active' : '' }}">
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ asset('reporte/venta-salida') }}"
                                            class="nav-link {{ 'venta-salida' == request()->segment(2) ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>S. Venta </p>
                                        </a>
                                    </li>
      ...
      <div class="container-fluid">
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline">
               POR: edelarosas@miumg.edu.gt            </div>
            <!-- Default to the left -->
            <strong>Copyright &copy; 2022 <a href="#" class="text-danger">RESEARCH & PLANNING</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
